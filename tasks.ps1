...
function Invoke-Etl    { Step 'ETL';      python -m customer_churn.etl }
function Invoke-Audit  { Step 'Audit';    python -m customer_churn.audit }
function Invoke-Train  { Step 'Training'; python -m customer_churn.train }
function Invoke-Test   { Step 'Tests';    python -m pytest --cov=customer_churn --cov-report=term-missing }
...
switch ($Task) {
    ...
    'clean'  { Invoke-Clean }
    'all'    { Invoke-Setup; Invoke-Audit; Invoke-Etl; Invoke-Train; Invoke-Test }
}
